...
a persistence unit "MoraLitumaOperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "MoraLitumaOperadoraJEE\pom.xml":
...
artifact ("MoraLitumaOperadoraJEE.war") is already built. You can build
