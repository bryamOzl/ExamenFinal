...
a persistence unit "MoraBryamCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "MoraBryamCajeraJEE\pom.xml":
...
artifact ("MoraBryamCajeraJEE.war") is already built. You can build
