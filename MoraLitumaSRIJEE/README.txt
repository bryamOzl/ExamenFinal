...
a persistence unit "MoraLitumaSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "MoraLitumaSRIJEE\pom.xml":
...
artifact ("MoraLitumaSRIJEE.war") is already built. You can build
